...
filename = "main.py"
preamble = ""
output_file = "~/public_html/test-symmetry-2"
cpus_per_task = 1
...
params = {
    ...
    # newLR = 0.01 | 10000.
    'LR':               [1.0],#[0.1, 1., 5., 10.],#[0.01],#{'T': np.linspace(0.01, 0.0001, 50)}, #[0.01], #[0.1], #[0.01], #[8.], # LR for FFT w. hann 50, 100 steps -> 2000.
    'OPT_LIM':          [1e-4], #[1e-8],
    ...
    ### CUSTOM VARS ###
    'CUSTOM_splitting': [1.1*2*3.1415926535, 3.3*2*3.1415926535, 5.0*2*3.1415926535],#[2.5, 5.0, 7.5, 10.0, 25.0], #[2.2, 4.4, 6.6, 8.8, 11.0],
    'CUSTOM_fine_splitting': [2.18*2*3.1415926535], #[2.2,]
