...
if __name__ == "__main__":
  ...
  if k=="jul8_sweep_omega": 
                          lbls = {
                           'jul8_sweep_omega': '3 (1)',
                           }

                          # count2qbit = False
                          # splitting_title = 'data:CUSTOM_fine_splitting'

  elif k=="jul8_sweep_omega_100": 
                          lbls = {
                           'jul8_sweep_omega_100': '3 (1)',
                           }

                          # count2qbit = False
                          # splitting_title = 'data:CUSTOM_fine_splitting'

  elif k=="jul8_sweep_long_omega_100": 
                          lbls = {
                           'jul8_sweep_long_omega_100_sq': '1 (1)',
                           'jul8_sweep_long_omega_100': '3 (1)',
                           }
  ...
  t = sb.lineplot(
    data=df,
    x='Spin Splitting $\\Delta$ (MHz)', y="Loss",#, col="time",
    style="pulse length [us]", 
    hue="Optimization Type",# size="size",
    # kind="line"
    alpha=0.4
    )
